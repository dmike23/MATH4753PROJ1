...
#' mypvalue function
#' this function creates a plot of the p value given certain parameters below.
#'
#' @param t0 this is your vertical line quantile value, (t alpha/2)
#' @param xmax this is the length of your x axis
#' @param n n is your sample size
#' @param alpha this is your default alpha value
#'
#' @return a plot of the p value with the interval and shaded region (acceptance and rejection regions.).
#' @export
#'
#' @examples
